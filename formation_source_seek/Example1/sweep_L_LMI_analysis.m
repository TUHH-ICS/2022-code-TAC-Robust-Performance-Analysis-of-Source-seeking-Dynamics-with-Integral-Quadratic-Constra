...
%---------------------------------------------------------------------------------------------------
% This script is used to generate convergence rate estimates with different
% restrictions of the multiplier search
close all
clear
clc
...
% Sector bounds
m=0.3; % lower bound on the sector
L=[0.3,1,5:1:15,16:0.05:18];%[1,16:0.05:18];  % Upper bound on the sector
n_L=length(L);
