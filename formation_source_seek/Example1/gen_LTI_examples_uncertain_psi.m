...
%---------------------------------------------------------------------------------------------------
% This script generates exact convergence rates for a fixed Laplacian and 
...
m_psi=2.02; % lower bound on the sector
L_psi_vec=[2.5:0.5:11,11:0.05:14];  % Upper bound on the sector
...
if save_data==1
    save('.\data\lb_lin_uncertain_psi');
end